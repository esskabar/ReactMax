...
class Products extends React.Component {
    ...
    getMoreProducts() {
        ...
        fetch(ReactMaxSettings.woo.url + "products?page=" + this.state.page + "&consumer_key=" + ReactMaxSettings.woo.consumer_key + "&consumer_secret=" + ReactMaxSettings.woo.consumer_secret)
        ...
        return (
            <div className="card">
                <div className="card-body">
                    ...
                    <p className="card-text"><Link to={ReactMaxSettings.path}>Return to homepage</Link></p>
                </div>
            </div>
        );
    }
